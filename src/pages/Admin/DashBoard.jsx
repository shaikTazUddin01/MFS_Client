...
const {data:transactions,isLoading:IsTransactionLoading}=useGetTransactionQuery()
  
console.log(transactions);

const transactionAmount=transactions?.data?.reduce((acc,curr)=>acc+curr?.transactionAmount,0)
        ...
        <div className="p-2 md:p-6 min-h-screen ">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow duration-300 border-l-4 border-blue-500">
                    ...
                    <p className="text-4xl font-bold text-blue-600 mt-3">{adminData?.data?.balance.toFixed(2)}৳</p>
                ...
                <div className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow duration-300 border-l-4 border-green-500">
                    ...
                    <p className="text-4xl font-bold text-green-600 mt-3">{transactionAmount.toFixed(2)}৳</p>
                ...
                <div className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow duration-300 border-l-4 border-yellow-500">
                    ...
                    <p className="text-4xl font-bold text-yellow-600 mt-3">{adminData?.data?.income.toFixed(2)}৳</p>
